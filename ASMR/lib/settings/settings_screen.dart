      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _CreditItem(
              provider: 'thetruwu FOLEY Chew Ice 1.wav',
              url: 'https://freesound.org/s/51675/',
            ),
            _CreditItem(
              provider: 'rubenvvuuren chip bite 2.wav',
              url: 'https://freesound.org/s/594423/',
            ),
            _CreditItem(
              provider: 'Taira Komori',
